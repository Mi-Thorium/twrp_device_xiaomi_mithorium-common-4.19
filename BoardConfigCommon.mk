...
BOARD_KERNEL_CMDLINE += console=ttyMSM0,115200,n8 androidboot.console=ttyMSM0 earlycon=msm_hsl_uart,0x78B0000 firmware_class.path=/system/etc/firmware printk.devkmsg=on
